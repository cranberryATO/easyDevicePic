...
export const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'app.byline.role': 'Software consultant and developer',
    'app.intro':
    ...
    'og.imageAlt': 'A 3D phone showing a screenshot, next to the easyDevicePic logo.',
  ...
  fr: {
    ...
    'meta.title': 'easyDevicePic — mockup d’appareil 3D à partir de votre capture d’écran',
    'meta.description':
 ...
 */
export const PAGES: Record<Locale, { app: string; about: string; privacy: string; legal: string }> =
  {
    en: {
      app: '/',
      about: '/about.html',
